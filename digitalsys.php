...
<table class="table table-hover table-dark " style="text-align: center;">
   <thead>
   	<tr>
   		<th scope="col" colspan="3"><p style="font-size: 30px;text-align: center"><u>Digital System Design Lectures</u></p></th>
   	</tr>
  ...
  <tbody>
    <tr>
      ...
      <td style="padding-top: 100px;"><h5>5.1 Introduction to Digital System Design</h5></td>
      
    </tr>
    <tr>
      <th scope="row">2</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>5.2 What is Analog Signal ?  </h5></td>
      
    </tr>
    <tr>
      <th scope="row">3</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>5.3 Need Of Digital Signal</h5></td>
     ...
     <tr>
      <th scope="row">4</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>5.4 Boolean Algebra </h5></td>
      
    </tr>
     <tr>
      <th scope="row">5</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>5.5 Redundancy Theorem</h5></td>
      
    </tr>
     <tr>
      <th scope="row">6</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>5.6 Sum Of Product(SOP)</h5></td>
      
    </tr>
     <tr>
      <th scope="row">7</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>5.7 Product Of Sum(POS)</h5></td>
      
    </tr>
     <tr>
      <th scope="row">8</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>5.8 Combinationational Logic Circuit</h5></td>
