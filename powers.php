...
<table class="table table-hover table-dark " style="text-align: center;">
   <thead>
   	<tr>
   		<th scope="col" colspan="3"><p style="font-size: 30px;text-align: center"><u>Power System Dynamics and Control Lectures</u></p></th>
   	</tr>
  ...
  <tbody>
    <tr>
      ...
      <td style="padding-top: 100px;"><h5>7.1 Introduction to Power System Dynamics and Control</h5></td>
      
    </tr>
    <tr>
      <th scope="row">2</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>7.2 Introduction to Power System Stability </h5></td>
      
    </tr>
    <tr>
      <th scope="row">3</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>7.3 Solution Of Switching Equation</h5></td>
     ...
     <tr>
      <th scope="row">4</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>7.4 The Equal Area Criteria For Stability  </h5></td>
      
    </tr>
     <tr>
      <th scope="row">5</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>7.5 Transient Stability Analysis</h5></td>
      
    </tr>
     <tr>
      <th scope="row">6</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>7.6 Synchronous Machine</h5></td>
      
    </tr>
     <tr>
      <th scope="row">7</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>7.7 Excitation Systems</h5></td>
      
    </tr>
     <tr>
      <th scope="row">8</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>7.8 Small Signal Stability</h5></td>
