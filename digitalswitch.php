...
<table class="table table-hover table-dark " style="text-align: center;">
   <thead>
   	<tr>
   		<th scope="col" colspan="3"><p style="font-size: 30px;text-align: center"><u>Digital Switching Lectures</u></p></th>
   	</tr>
  ...
  <tbody>
    <tr>
      ...
      <td style="padding-top: 100px;"><h5>2.1 Introduction to Digital Switching</h5></td>
      
    </tr>
    <tr>
      <th scope="row">2</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>2.2 Strowger Automatic Exchange</h5></td>
      
    </tr>
    <tr>
      <th scope="row">3</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>2.3 Crossbar Switching</h5></td>
     ...
     <tr>
      <th scope="row">4</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>2.4 Logic Circuit For Crossbar Operation  </h5></td>
      
    </tr>
     <tr>
      <th scope="row">5</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>2.5 Multistage Interconnection Networks</h5></td>
      
    </tr>
     <tr>
      <th scope="row">6</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>2.6 Blocking Probability of  Crossbar Switching</h5></td>
      
    </tr>
     <tr>
      <th scope="row">7</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>2.7 Call Congestion And Time Congestion</h5></td>
      
    </tr>
     <tr>
      <th scope="row">8</th>
      <td><video height="250px" width="250px" src="videos/1.mp4" controls></video></td>
      <td style="padding-top: 100px;"><h5>2.8 Clos Network</h5></td>
